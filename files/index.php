...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/com.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/col.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/com.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/col.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/" class="img-rounded"/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF.</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> m</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF.</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>Computer</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Email: </strong>controller. admin@coderscluster.com</h4>
            </div>
